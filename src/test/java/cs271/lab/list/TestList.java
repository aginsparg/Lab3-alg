...
public class TestList {
  ...
  public void testContains() {
    // wrote assertions using list.contains(77) that hold before and after adding 77 to the list
  ...
  public void testContainsAll() {
    ...
    list.add(77);
    list.add(66);
    // used containsAll and Arrays.asList (see above),
  ...
  public void testAddAll() {
    // in a single statement used addAll and Arrays.asList,
